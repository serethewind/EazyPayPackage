...
public class CustomerService implements ICustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber, String correlationId) {
        ...
        return CustomerDetailsDto.builder()
                ...
                .loansDto(loansFeignClient.fetchLoanDetails(mobileNumber, correlationId) != null ? loansFeignClient.fetchLoanDetails(mobileNumber, correlationId).getBody() : null)
                .cardsDto(cardsFeignClient.fetchCardDetails(mobileNumber, correlationId) != null ? cardsFeignClient.fetchCardDetails(mobileNumber, correlationId).getBody() : null)
                .build();
    }
}
